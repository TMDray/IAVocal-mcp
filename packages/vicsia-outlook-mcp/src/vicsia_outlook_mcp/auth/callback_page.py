"""OAuth callback HTML pages for vicsia-outlook-mcp.

Note: Outlook uses device code flow (no local callback HTTP server), so these
pages are kept for future browser-based reauth scenarios.
"""
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .provider { color: #e67e22; font-weight: 600; }
        .account { color: #888; font-size: 0.9rem; margin-top: 0.3rem; }
        .message { color: #666; font-size: 0.95rem; margin-top: 1rem; line-height: 1.5; }
        .close-hint { color: #aaa; font-size: 0.8rem; margin-top: 1.5rem; }
        .btn {
...
def success_page(account: str = "", provider: str = "Outlook") -> str:
